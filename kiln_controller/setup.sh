...
# touchscreen failures on Pi 4 Bookworm. xinit/X11 is used exclusively.
...
# Tries HDMI-1, HDMI-A-1, and HDMI-2 to cover both Pi 4 HDMI ports.
...
# Disable screen blanking and power management — display must always stay on.
xset s off
xset s noblank
xset -dpms
